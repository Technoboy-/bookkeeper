...
public class Main3 {
    ...
    static int doMain(String[] args) {
        ...
        argsList.add("c");
        argsList.add("conf/bk_server.conf");
        argsList.add("z");
        argsList.add("localhost:7181");
        argsList.add("m");
        argsList.add("/Users/momo/tboy/bookeeper/zkledgerpath");
        argsList.add("p");
        argsList.add("9999");
        argsList.add("j");
        argsList.add("/Users/momo/tboy/bookeeper/journal");
        argsList.add("i");
        argsList.add("/Users/momo/tboy/bookeeper/indexdirs");
        argsList.add("l");
        argsList.add("/Users/momo/tboy/bookeeper/ledgerdirs");
        
        ServerConfiguration conf;

        // 0. parse command line
        try {
            conf = parseCommandLine(argsList.toArray(new String[]{}));
